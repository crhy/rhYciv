...
namespace RhyCiv.UI.CompatAlternate;

/// <summary>
/// This class is dynamically instantiated when ToT files are detected
/// </summary>
[UsedImplicitly]
public class CompatAlternateInterface(IMain main) : ClassicInterface(main)
{
    ...
    [
        ...
        new()
        {
            Key = "KINGDOM", Defaults = new List<MenuElement>
            {
                ...
                new("-", Shortcut.None, Key.None),
                new("&Diplomacy|Ctrl+D", new Shortcut(Key.D, ctrl: true), Key.D, commandId: Diplomacy),
        ...
        new()
        {
            Key = "VIEW", Defaults = new List<MenuElement>
            {
                ...
                new("City Layout", Shortcut.None, Key.None, omitIfNoCommand: true),
            },
        },
        ...
        new()
        {
            Key = "@ORDERS", Defaults = new List<MenuElement>
            {
                ...
                new("Transform to ...|o", new Shortcut(Key.O), Key.None, omitIfNoCommand: true),
                new("Build &Teleporter|j", new Shortcut(Key.J), Key.T, omitIfNoCommand: true),
                ...
                new("Teleport|n", new Shortcut(Key.N), Key.None, omitIfNoCommand: true),
        ...
        new()
        {
            Key = "MAP", Defaults = new List<MenuElement>
            {
                ...
                new("&Select Map|Ctrl+Shift+1",
                    new Shortcut(Key.D1, ctrl: true, shift: true), Key.S, omitIfNoCommand: true),
                new("&Import Map|Ctrl+Shift+2",
                    new Shortcut(Key.D2, ctrl: true, shift: true), Key.I, omitIfNoCommand: true),
                new("&Export Map|Ctrl+Shift+3",
                    new Shortcut(Key.D3, ctrl: true, shift: true), Key.E, omitIfNoCommand: true),
            }
        },
